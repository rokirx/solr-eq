...
public class QueryParser extends SolrQueryParserBase implements QueryParserConstants {
    ...
    private static Set<Integer> disallowedPostMultiTerm = new HashSet<Integer>(Arrays.asList(COLON, STAR, FUZZY_SLOP, CARAT, AND, OR));
    ...
    protected Query newFieldQuery(Analyzer analyzer, String field, String queryText, boolean quoted, boolean fieldAutoGenPhraseQueries,
        ...
        boolean treatAsQuoted = getSplitOnWhitespace() ? (quoted || fieldAutoGenPhraseQueries || getAutoGeneratePhraseQueries()) : quoted;
    ...
    final public Query Term(String field) throws ParseException, SyntaxError {
        ...
        case RANGEEX_START:
            ...
            q = getRangeQuery(getField(field), startOpen ? null : discardEscapeChar(goop1.image), endOpen ? null : discardEscapeChar(goop2.image),
                    startInc, endInc);
            break;
        case QUOTED:
    ...
    private static void jj_la1_init_0() {
        jj_la1_0 = new int[] { 0x16000, 0x16000, 0x68000, 0x68000, 0xf69e8000, 0xf69fe000, 0xf69fe000, 0x4800000, 0x1000000, 0x1000000, 0x1000000,
                0xf6980000, 0x74880000, 0x8000000, 0x1000000, 0x9000000, 0x9000000, 0x80000000, 0x0, 0x0, 0x0, 0x1000000, 0x8000000, 0x1000000,
                0x9000000, 0x9000000, 0xf6880000, };
    }

    private static void jj_la1_init_1() {
        jj_la1_1 = new int[] { 0x0, 0x0, 0x0, 0x0, 0xf, 0xf, 0xf, 0x0, 0x0, 0x0, 0x0, 0xf, 0x8, 0x0, 0x0, 0x0, 0x0, 0x1, 0x190, 0x190, 0x60, 0x0, 0x0,
                0x0, 0x0, 0x0, 0x9, };
    }
