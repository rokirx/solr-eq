...
import org.apache.solr.handler.component.eq.TestEqQueryComponent;
import org.junit.BeforeClass;
import org.junit.Test;

public class TestMatchQueryComponent extends SolrCloudTestCase {
    ...
    public static void setupCluster() throws Exception {
        ...
        // add a documents
        new UpdateRequest().add(id, "1", "title_str", "Title 1", "text_txt", "Text 1 London", "date_dt", "2019-01-01T00:00:00Z")
                ...
                .add(id, "5", "title_str", "Title 5", "text_txt", "Text 5 London", "date_dt", "2019-01-05T00:00:00Z")
                .commit(cluster.getSolrClient(), COLLECTION);
    }

    @Test
    public void testEqComponent() throws Exception {
        final SolrQuery solrQuery = new SolrQuery("q", "test london");
        solrQuery.setSort(id, ORDER.asc);
        solrQuery.set(CommonParams.DF, "title_str");
